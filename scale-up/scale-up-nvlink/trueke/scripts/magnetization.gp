...
set output 'plots/magnetization.eps'
set ylabel '[<M>]'
#set ylabel rotate right
set xlabel 'T'
set xtics font "Times, 20"
set ytics font "Times, 20"
set title '(PT) Ising 3D Random Field Magnetization'
...
plot	'data/magnetization.dat' using 1:2 notitle with linespoints pt 7 lt 3 lc rgb "black",\
	'data/magnetization.dat' using 1:2:7 notitle linestyle 2 with errorbars
