...
set output 'plots/dis_susceptibility.eps'
set ylabel '[<Xdis>]'
#set log y
...
set title '(PT) Ising 3D Random Field Disconnected Susceptibility'
...
plot	'data/dis_susceptibility.dat' using 1:2 notitle 	with linespoints pt 7 lt 3 lc rgb "black",\
	'data/dis_susceptibility.dat' using 1:2:7 notitle linestyle 2 with errorbars
