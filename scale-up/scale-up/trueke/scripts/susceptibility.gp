...
set output 'plots/susceptibility.eps'
set ylabel '[<X>]'
#set log y
...
set title '(PT) Ising 3D Random Field Susceptibility'
...
plot	'data/susceptibility.dat' using 1:2 notitle 	with linespoints pt 7 lt 3 lc rgb "black",\
	'data/susceptibility.dat' using 1:2:7 notitle linestyle 2 with errorbars		
