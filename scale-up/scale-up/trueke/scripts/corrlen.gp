...
set title '(PT) Ising 3D Random Field Correlation Length'
...
plot	'data/corrlen.dat' using 1:2 notitle 	with linespoints pt 7 lt 3 lc rgb "black",\
	'data/corrlen.dat' using 1:2:7 notitle linestyle 2 with errorbars
