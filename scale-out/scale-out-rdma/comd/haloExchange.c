...
HaloExchange* initAtomHaloExchange(Domain* domain, LinkCell* boxes)
{
   ...
   cudaMalloc((void**)&(hh->sendBufM), hh->bufCapacity);
   cudaMalloc((void**)&(hh->sendBufP), hh->bufCapacity);
   cudaMalloc((void**)&(hh->recvBufM), hh->bufCapacity);
   cudaMalloc((void**)&(hh->recvBufP), hh->bufCapacity);
...
void destroyHaloExchange(HaloExchange** haloExchange)
{
   ...
   cudaFree((*haloExchange)->sendBufM);
   cudaFree((*haloExchange)->sendBufP);
   cudaFree((*haloExchange)->recvBufM);
   cudaFree((*haloExchange)->recvBufP);
